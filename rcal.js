...
// console.log(outputLower,outputLower);
...
function pressOperator(e) {
  ...
  if (lastOperator.includes('+') || lastOperator.includes('-') || lastOperator.includes('×') || lastOperator.includes('÷')) {
